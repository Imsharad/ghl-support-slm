...
| Gate1 seal | Fable, Sol, shark | `eval/challenge_v2.jsonl`, `eval/SEAL_v2.json` | B3v2, shark approval | ~18:45 | `uv run python eval/check_challenge.py --seal` (refuses if seal exists) | awaiting shark approval (page 680ed19) | — |
