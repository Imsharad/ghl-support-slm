...
""",
    ...
    dict(
        ...
        due="Mon 2026-09-07 10:30", est=1.5, deps=["D2", "B4", "C1"],
        paths=["artifacts/selection.json", "train/runs/main/", "eval/results/base-test-raw.jsonl",
               "eval/results/tuned-test-raw.jsonl", "eval/results/*-auto.json", "docs/SELECTION.md"],
        brief="""
