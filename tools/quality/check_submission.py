...
Usage:
    uv run python tools/quality/check_submission.py
    uv run python tools/quality/check_submission.py submission.json
"""
...
from tools.artifacts.check_artifacts import (  # noqa: E402
    DEFAULT_MANIFEST,
    ManifestError,
    load_manifest,
    verify_artifact,
