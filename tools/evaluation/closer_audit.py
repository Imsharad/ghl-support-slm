...
Usage
-----
uv run python tools/evaluation/closer_audit.py data/v2/admissions_raw.jsonl
uv run python tools/evaluation/closer_audit.py data/v2/admissions_raw.jsonl --json out.json
"""
