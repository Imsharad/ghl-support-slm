...
Usage:
    uv run python tools/training/check_run.py train/runs/ghl-support-qlora
    uv run python tools/training/check_run.py train/runs/smoke-ghl-support-qlora --no-generate
"""
