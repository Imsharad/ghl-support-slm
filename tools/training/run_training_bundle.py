...
def main():
    ...
    if args.train:
        ...
        subprocess.run([sys.executable, str(ROOT / "tools/training/check_run.py"), str(smoke_dir),
    ...
    base = json.loads((ROOT / "configs/models/versions.json").read_text())["base_model"]
